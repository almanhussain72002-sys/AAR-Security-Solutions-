...
export const metadata: Metadata = {
  ...
  title: {
    default: "AAR Security Solutions | Security Solutions in Mangalore",
    template: "%s | AAR Security Solutions"
  },
  description:
    "AAR Security Solutions provides CCTV installation, smart door locks, home automation, access control, boom barriers, fire alarms, networking, smart guard patrol systems, and IT infrastructure across Mangalore and Karnataka.",
  keywords: [
